...
import torch
import json
from searcher import Dense_Searcher, Sparse_Searcher, Bing_Searcher
...
def get_model():
    ...
    if search_type == "dense_searcher":
        searcher = Dense_Searcher()
    elif search_type == "sparse_searcher":
